...
def client_handler(conn, init_array, mat_in_arr):
    ...
    # reset the values of the out array
    ...
    while jj < 32:
        ...
        if jj == low:
            ...
            for neighbor in neighbors:
                ...
                if not_on_left_edge and not_on_right_edge and not_on_top_row and not_on_bottom_row and (
                        0 <= neighbor < 32):
                    out[neighbor] += 0.4
        else:
    ...
    try:
        for k in range(5):
            ...
            byte_array = bytearray(x)
            for i in range(len(byte_array)):
                if byte_array[i] == 0x81 and byte_array[i + 1] == 0x02 and breath == 0:
                    breath = byte_array[i + 4]
                if byte_array[i] == 0x85 and byte_array[i + 1] == 0x02 and heart == 0:
                    heart = byte_array[i + 4]
...
def web_page(breath, heart, out):
    ...
    <span class="patch" style="opacity:""" + str(
        out[0]) + """;">&#11035;</span></td><td><span class="patch" style=opacity:""" + str(
        out[1]) + """;">&#11035;</span></td><td><span class="patch" style="opacity:""" + str(
        out[2]) + """;">&#11035;</span></td><td><span class="patch" style="opacity:""" + str(out[3]) + """;">&#11035;</span></td>
			</tr>
			<tr>
				<td><span class="patch" style="opacity:""" + str(
        out[4]) + """;">&#11035;</span></td><td><span class="patch" style="opacity:""" + str(
        out[5]) + """;">&#11035;</span></td><td><span class="patch" style="opacity:""" + str(
        out[6]) + """;">&#11035;</span></td><td><span class="patch" style="opacity:""" + str(out[7]) + """;">&#11035;</span></td>
		</tr>
			<tr>
				<td><span class="patch" style="opacity:""" + str(
        out[8]) + """;">&#11035;</span></td><td><span class="patch" style="opacity:""" + str(
        out[9]) + """;">&#11035;</span></td><td><span class="patch" style="opacity:""" + str(
        out[10]) + """;">&#11035;</span></td><td><span class="patch" style="opacity:""" + str(out[11]) + """;">&#11035;</span></td>
		</tr>
			<tr>
				<td><span class="patch" style="opacity:""" + str(
        out[12]) + """;">&#11035;</span></td><td><span class="patch" style="opacity:""" + str(
        out[13]) + """;">&#11035;</span></td><td><span class="patch" style="opacity:""" + str(
        out[14]) + """;">&#11035;</span></td><td><span class="patch" style="opacity:""" + str(out[15]) + """;">&#11035;</span></td>
		</tr>
			<tr>
				<td><span class="patch" style="opacity:""" + str(
        out[16]) + """;">&#11035;</span></td><td><span class="patch" style="opacity:""" + str(
        out[17]) + """;">&#11035;</span></td><td><span class="patch" style="opacity:""" + str(
        out[18]) + """;">&#11035;</span></td><td><span class="patch" style="opacity:""" + str(out[19]) + """;">&#11035;</span></td>
		</tr>
			<tr>
				<td><span class="patch" style="opacity:""" + str(
        out[20]) + """;">&#11035;</span></td><td><span class="patch" style="opacity:""" + str(
        out[21]) + """;">&#11035;</span></td><td><span class="patch" style="opacity:""" + str(
        out[22]) + """;">&#11035;</span></td><td><span class="patch" style="opacity:""" + str(out[23]) + """;">&#11035;</span></td>
		</tr>
			<tr>
				<td><span class="patch" style="opacity:""" + str(
        out[24]) + """;">&#11035;</span></td><td><span class="patch" style="opacity:""" + str(
        out[25]) + """;">&#11035;</span></td><td><span class="patch" style="opacity:""" + str(
        out[26]) + """;">&#11035;</span></td><td><span class="patch" style="opacity:""" + str(out[27]) + """;">&#11035;</span></td>
		</tr>
			<tr>
				<td><span class="patch" style="opacity:""" + str(
        out[28]) + """;">&#11035;</span></td><td><span class="patch" style="opacity:""" + str(
        out[29]) + """;">&#11035;</span></td><td><span class="patch" style="opacity:""" + str(
        out[30]) + """;">&#11035;</span></td><td><span class="patch" style="opacity:""" + str(out[31]) + """;">&#11035;</span></td>
		</tr>
